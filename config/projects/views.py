...
def nesting(request):  # 둥지의 둥지
    return render(request, "wrm/nesting.html")


def fabre(request):  # 파브르 프로젝트
    return render(request, "wrm/fabre.html")


def celsius(request):  # 열
    return render(request, "wrm/celsius.html")


def burnout(request):  # 번아웃 제곱
    return render(request, "wrm/burnout.html")


def bricklayer(request):  # 벽돌공
    return render(request, "wrm/bricklayer.html")


def doongsite(request):  # 둥사이트
    return render(request, "wrm/doongsite.html")


def doongzipedia(request):  # 둥키백과
    return render(request, "wrm/doongzipedia.html")


def a_piece_of_doongzi(request):  # 쪽글 프로젝트
    return render(request, "wrm/a_piece_of_doongzi.html")


def doongzi_log(request):  # 둥지로그
    return render(request, "wrm/doongzi_log.html")


def doongzi_workroom(request):  # 작업실
    return render(request, "wrm/doongzi_workroom.html")
